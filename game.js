...
function update(){
    ...
    ballBrickCollision();
    // if(bricks[newrow][col].hits === 1)
    // {
    //     console.log(newrow);
    //     console.log(col);
    //     console.log('tamam');
    //     bricks[newrow][col].fillColor = "#dcd5d5";
    //     ctx.fillStyle = bricks[newrow][col].fillColor;
    //     ctx.fillRect(bricks[newrow][col].x, bricks[newrow][col].y, brick.width, brick.height);
    // }
